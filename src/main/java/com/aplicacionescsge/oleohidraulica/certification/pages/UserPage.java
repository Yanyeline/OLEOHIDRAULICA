...
public class UserPage {
    ...
    public static Target TXT_SEARCH_USER = Target.the("").located(By.xpath("//div[@id='userTable_filter']//input[@type='search']"));
    ...
    public static Target DDL_ROLE_OPTION = Target.the("").locatedBy(
            "(//div[@class='form-group']//select[@name='rol']//option[contains(text(),'{0}')])[1]");
    ...
    public static Target DDL_ROLE_OPTION_UPDATE = Target.the("").locatedBy(
            "//div[@class='form-group']//select[@id='rol_update']//option[contains(text(),'{0}')]");
